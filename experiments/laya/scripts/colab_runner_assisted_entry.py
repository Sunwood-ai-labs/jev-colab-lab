"""Colab entrypoint for the explicitly reflex-assisted real-Laya replay."""
...
if __name__ == "__main__":
    ...
    sys.argv = [
        "runner.py",
        "--video",
        "/content/laya-rules-v2-7-reflex-assisted.mp4",
        "--json",
        "/content/laya-rules-v2-7-reflex-assisted.json",
        "--prompt-profile",
        "platformer_rules_v2",
        "--state-encoding",
        "semantic_v1",
